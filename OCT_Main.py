...
if __name__=="__main__":
    ...
    location = 'Documents\GitHub\Optic_Disk\OCT_Scan'
    ...
    for i in images:
        ...
        thresh = threshold_tb(img1, global_threshold, 0)
        ...
        while (case != None):
            ...
            picture_l = cv2.line(picture_color, (1,int(yl_1)),(int(width-1),int(yl_2)), (255,255,0),3)
            picture_r = cv2.line(picture_l, (1,int(yr_1)),(int(width-1),int(yr_2)), (0,255,0),3)
