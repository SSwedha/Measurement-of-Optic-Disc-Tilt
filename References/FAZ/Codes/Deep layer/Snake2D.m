...
%Wline = 0.12
% Process input
defaultoptions=struct('Verbose',true,'nPoints',150,'Wline',.07,'Wedge',1.4,'Wterm',1.5,'Sigma1',3,'Sigma2',15,'Alpha',0.7,'Beta',0.1,'Delta',0.05,'Gamma',0.8,'Kappa',1.9,'Iterations',200,'GIterations',0,'Mu',0.45,'Sigma3',2);
